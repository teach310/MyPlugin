...
#ifndef SAMPLEPLUGIN_SWIFT_H
#define SAMPLEPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SamplePlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12SamplePlugin9BLESample")
@interface BLESample : NSObject <CBCentralManagerDelegate, CBPeripheralDelegate>
...
SWIFT_CLASS("_TtC12SamplePlugin15BLEServerSample")
@interface BLEServerSample : NSObject <CBPeripheralManagerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC12SamplePlugin18CB4UCentralManager")
...
@interface CB4UCentralManager (SWIFT_EXTENSION(SamplePlugin)) <CBCentralManagerDelegate>
- (void)centralManagerDidUpdateState:(CBCentralManager * _Nonnull)central;
- (void)centralManager:(CBCentralManager * _Nonnull)central didConnectPeripheral:(CBPeripheral * _Nonnull)peripheral;
- (void)centralManager:(CBCentralManager * _Nonnull)central didDisconnectPeripheral:(CBPeripheral * _Nonnull)peripheral error:(NSError * _Nullable)error;
- (void)centralManager:(CBCentralManager * _Nonnull)central didFailToConnectPeripheral:(CBPeripheral * _Nonnull)peripheral error:(NSError * _Nullable)error;
...
@interface CB4UCentralManager (SWIFT_EXTENSION(SamplePlugin)) <CBPeripheralDelegate>
- (void)peripheral:(CBPeripheral * _Nonnull)peripheral didDiscoverServices:(NSError * _Nullable)error;
- (void)peripheral:(CBPeripheral * _Nonnull)peripheral didDiscoverCharacteristicsForService:(CBService * _Nonnull)service error:(NSError * _Nullable)error;
- (void)peripheral:(CBPeripheral * _Nonnull)peripheral didUpdateValueForCharacteristic:(CBCharacteristic * _Nonnull)characteristic error:(NSError * _Nullable)error;
- (void)peripheral:(CBPeripheral * _Nonnull)peripheral didWriteValueForCharacteristic:(CBCharacteristic * _Nonnull)characteristic error:(NSError * _Nullable)error;
...
SWIFT_EXTERN int32_t cb4u_central_manager_retrieve_peripherals_with_identifiers(void const * _Nonnull centralPtr, char const * _Nullable const * _Nonnull peripheralIds, int32_t peripheralIdsCount, char * _Nonnull sb, int32_t sbSize) SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_EXTERN int32_t cb4u_peripheral_discover_characteristics(void const * _Nonnull centralPtr, char const * _Nonnull peripheralId, char const * _Nonnull serviceId, char const * _Nullable const * _Nonnull characteristicUUIDs, int32_t characteristicUUIDsCount) SWIFT_WARN_UNUSED_RESULT;


SWIFT_EXTERN int32_t cb4u_peripheral_discover_services(void const * _Nonnull centralPtr, char const * _Nonnull peripheralId, char const * _Nullable const * _Nonnull serviceUUIDs, int32_t serviceUUIDsCount) SWIFT_WARN_UNUSED_RESULT;


SWIFT_EXTERN int32_t cb4u_peripheral_read_value_for_characteristic(void const * _Nonnull centralPtr, char const * _Nonnull peripheralId, char const * _Nonnull serviceId, char const * _Nonnull characteristicId) SWIFT_WARN_UNUSED_RESULT;


SWIFT_EXTERN int32_t cb4u_peripheral_set_notify_value_for_characteristic(void const * _Nonnull centralPtr, char const * _Nonnull peripheralId, char const * _Nonnull serviceId, char const * _Nonnull characteristicId, BOOL enabled) SWIFT_WARN_UNUSED_RESULT;


SWIFT_EXTERN int32_t cb4u_peripheral_write_value_for_characteristic(void const * _Nonnull centralPtr, char const * _Nonnull peripheralId, char const * _Nonnull serviceId, char const * _Nonnull characteristicId, uint8_t const * _Nonnull dataBytes, int32_t dataLength, int32_t writeType) SWIFT_WARN_UNUSED_RESULT;
